...
<body>
    <div class="col-md-8 col-md-offset-2">
        <h2 class="text-center">Manage CPI</h2>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    <li><i class="fa fa-file-text-o"></i> All the current Posts</li>
                    <a href="#" class="add-modal"><li><button class=" btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Add A New Record </button></li></a>
                </ul>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="postTable" style="visibility: hidden;">
                        ...
                        <tbody>
                            @foreach($posts as $post)
                                <tr class="item{{$post->avg_retail_price_id}} @if($post->unit) warning @endif">
                                    <td>{{$post->avg_retail_price_id}}</td>
                                    <td>{{$post->item}}</td>
                                    <td>
                                    {{$post->unit}}
                                    </td>

                                      <td>{{$post->ksh_per_unit}}</td>
                                   
                                    <td>
                                        <button class="show-modal btn btn-success" data-id="{{$post->avg_retail_price_id}}" data-title="{{$post->item}}" data-content="{{$post->item}}">
                                        <span class="glyphicon glyphicon-eye-open"></span> Show</button>

                                        <button class="edit-modal btn btn-info" data-id="{{$post->avg_retail_price_id}}" data-title="{{$post->item}}" data-content="{{$post->item}}">
